...
module.exports = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.1//EN\" \"http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd\">\n<html xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"<%= i18n.code %>\">\n\n<head>\n\t<title><%= i18n.info %></title>\n\t<meta http-equiv=\"Content-Type\" content=\"application/xhtml+xml; charset=utf-8\" />\n</head>\n\n<body>\n\t<div id=\"title-page\">\n\t\t<h1 class=\"title\" style=\"text-align:center;margin-top:1em\"><%= title %></h1>\n\t\t<h2 class=\"author\" style=\"text-align:center\"><%= author %></h2>\n\t</div>\n    <% if (Array.isArray(tags) && tags.length) { %>\n        <div class=\"part-title-wrap\" style=\"margin-top:2em;text-align:center\">\n            <% tags = tags.join('</code>, <code>'); %>\n            <code><%- tags %></code>\n        </div>\n    <% } %>\n</body>\n\n</html>\n"
